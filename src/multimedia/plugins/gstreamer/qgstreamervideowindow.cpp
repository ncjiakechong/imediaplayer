...
QGstreamerVideoWindow::QGstreamerVideoWindow(iObject *parent, const iByteArray &elementName)
...
bool QGstreamerVideoWindow::processSyncMessage(const iGstreamerMessage &message)
{
    return m_videoOverlay.processSyncMessage(message);
}

bool QGstreamerVideoWindow::processBusMessage(const iGstreamerMessage &message)
{
    return m_videoOverlay.processBusMessage(message);
}

iRect QGstreamerVideoWindow::displayRect() const
{
    return m_displayRect;
}

void QGstreamerVideoWindow::setDisplayRect(const iRect &rect)
{
...
iSize QGstreamerVideoWindow::nativeSize() const
{
