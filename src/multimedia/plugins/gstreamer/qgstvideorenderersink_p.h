...
private slots:
    bool handleEvent(iScopedLock *locker);
    void updateSupportedFormats();

private:
    void notify();
    bool waitForAsyncEvent(iScopedLock *locker, QWaitCondition *condition, unsigned long time);
    ...
    std::list<QGstVideoRenderer *> m_renderers;
