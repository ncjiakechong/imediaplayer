...
const iLatin1String QGstVideoRendererPluginKey("gstvideorenderer");
...
class QGstVideoRendererPlugin : public iObject, public QGstVideoRendererInterface
{
    Q_OBJECT
    Q_INTERFACES(QGstVideoRendererInterface)
public:
    explicit QGstVideoRendererPlugin(iObject *parent = 0);
