...
// see ilocale_data_p.h for more info on generated data
    ...
    short toShort(const iString &s, bool *ok = nullptr) const;
    ushort toUShort(const iString &s, bool *ok = nullptr) const;
    int toInt(const iString &s, bool *ok = nullptr) const;
    uint toUInt(const iString &s, bool *ok = nullptr) const;
    long toLong(const iString &s, bool *ok = nullptr) const;
    ulong toULong(const iString &s, bool *ok = nullptr) const;
    xlonglong toLongLong(const iString &s, bool *ok = nullptr) const;
    xulonglong toULongLong(const iString &s, bool *ok = nullptr) const;
    float toFloat(const iString &s, bool *ok = nullptr) const;
    double toDouble(const iString &s, bool *ok = nullptr) const;

    short toShort(const iStringRef &s, bool *ok = nullptr) const;
    ushort toUShort(const iStringRef &s, bool *ok = nullptr) const;
    int toInt(const iStringRef &s, bool *ok = nullptr) const;
    uint toUInt(const iStringRef &s, bool *ok = nullptr) const;
    long toLong(const iStringRef &s, bool *ok = nullptr) const;
    ulong toULong(const iStringRef &s, bool *ok = nullptr) const;
    xlonglong toLongLong(const iStringRef &s, bool *ok = nullptr) const;
    xulonglong toULongLong(const iStringRef &s, bool *ok = nullptr) const;
    float toFloat(const iStringRef &s, bool *ok = nullptr) const;
    double toDouble(const iStringRef &s, bool *ok = nullptr) const;

    short toShort(iStringView s, bool *ok = nullptr) const;
    ushort toUShort(iStringView s, bool *ok = nullptr) const;
    int toInt(iStringView s, bool *ok = nullptr) const;
    uint toUInt(iStringView s, bool *ok = nullptr) const;
    long toLong(iStringView s, bool *ok = nullptr) const;
    ulong toULong(iStringView s, bool *ok = nullptr) const;
    xlonglong toLongLong(iStringView s, bool *ok = nullptr) const;
    xulonglong toULongLong(iStringView s, bool *ok = nullptr) const;
    float toFloat(iStringView s, bool *ok = nullptr) const;
    double toDouble(iStringView s, bool *ok = nullptr) const;
