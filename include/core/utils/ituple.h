...
template <class T0, class T1 = iNullTypeList, class T2 = iNullTypeList, class T3 = iNullTypeList,
    class T4 = iNullTypeList, class T5 = iNullTypeList, class T6 = iNullTypeList, class T7 = iNullTypeList,
    class T8 = iNullTypeList, class T9 = iNullTypeList, class T10 = iNullTypeList>
struct iTuple
{
    typedef typename iTypeListType<T0,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10>::HeadType Type;

    enum iTupleLengthType { length = Type::length };
