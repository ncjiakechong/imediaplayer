...
{
    void* user_data;
    void (*setThreshold)(void* user_data, const char* patterns, bool reset);
    bool (*filter)(void* user_data, const char* tag, iLogLevel level);
    void (*metaCallback)(void* user_data, const char* tag, iLogLevel level, const char* file, const char* function, int line, const char* msg, int size);
    void (*dataCallback)(void* user_data, const char* tag, iLogLevel level, const char* file, const char* function, int line, const void* msg, int size);
};
...
class IX_CORE_EXPORT iLogger {
 public:
    ...
    static void asprintf(const char* tag, iLogLevel level, const char* file, const char* function, int line,
                         const char *format, ...) IX_GCC_PRINTF_ATTR(6, 7);
    static void binaryData(const char* tag, iLogLevel level, const char* file, const char* function, int line,
                           const void* data, int size);

    iLogger();
    ~iLogger();

    bool start(const char *tag, iLogLevel level, const char* file, const char* function, int line);
    void end();
    ...
    // for iLatin1StringView
    void append(const iLatin1StringView& value);
...
IX_CORE_EXPORT iLogger& operator<<(iLogger&, const iLatin1StringView&);
...
void iLogMeta(const char* tag, iLogLevel level, const char* file, const char* function, int line,
              const T1& value1, const T2& value2, const T3& value3, const T4& value4, const T5& value5, const T6& value6, const T7& value7, const T8& value8,
              const T9& value9, const T10& value10, const T11& value11, const T12& value12, const T13& value13, const T14& value14, const T15& value15,
...
void iLogMeta(const char* tag, iLogLevel level, const char* file, const char* function, int line,
              const T1& value1, const T2& value2, const T3& value3, const T4& value4, const T5& value5, const T6& value6, const T7& value7, const T8& value8,
              const T9& value9, const T10& value10, const T11& value11, const T12& value12, const T13& value13, const T14& value14, const T15& value15,
              const T16& value16, const T17& value17) {
    iLogger logger;
    if (!logger.start(tag, level, file, function, line))
        return;
...
void iLogMeta(const char* tag, iLogLevel level, const char* file, const char* function, int line,
              const T1& value1, const T2& value2, const T3& value3, const T4& value4, const T5& value5, const T6& value6, const T7& value7, const T8& value8,
              const T9& value9, const T10& value10, const T11& value11, const T12& value12, const T13& value13, const T14& value14) {
    iLogger logger;
    if (!logger.start(tag, level, file, function, line))
        return;
...
void iLogMeta(const char* tag, iLogLevel level, const char* file, const char* function, int line,
              const T1& value1, const T2& value2, const T3& value3, const T4& value4, const T5& value5, const T6& value6, const T7& value7, const T8& value8,
              const T9& value9, const T10& value10, const T11& value11, const T12& value12, const T13& value13) {
    iLogger logger;
    if (!logger.start(tag, level, file, function, line))
        return;
...
void iLogMeta(const char* tag, iLogLevel level, const char* file, const char* function, int line,
              const T1& value1, const T2& value2, const T3& value3, const T4& value4, const T5& value5, const T6& value6, const T7& value7, const T8& value8,
              const T9& value9, const T10& value10, const T11& value11) {
    iLogger logger;
    if (!logger.start(tag, level, file, function, line))
        return;
...
void iLogMeta(const char* tag, iLogLevel level, const char* file, const char* function, int line,
              const T1& value1, const T2& value2, const T3& value3, const T4& value4, const T5& value5, const T6& value6, const T7& value7, const T8& value8,
              const T9& value9, const T10& value10) {
    iLogger logger;
    if (!logger.start(tag, level, file, function, line))
        return;
...
template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6,
         typename T7>
void iLogMeta(const char* tag, iLogLevel level, const char* file, const char* function, int line,
              const T1& value1, const T2& value2, const T3& value3, const T4& value4, const T5& value5, const T6& value6, const T7& value7) {
    iLogger logger;
    if (!logger.start(tag, level, file, function, line))
        return;
...
template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
void iLogMeta(const char* tag, iLogLevel level, const char* file, const char* function, int line,
              const T1& value1, const T2& value2, const T3& value3, const T4& value4, const T5& value5, const T6& value6) {
    iLogger logger;
    if (!logger.start(tag, level, file, function, line))
        return;
...
void iLogMeta(const char* tag, iLogLevel level, const char* file, const char* function, int line,
              const T1& value1, const T2& value2, const T3& value3, const T4& value4, const T5& value5) {
    iLogger logger;
    if (!logger.start(tag, level, file, function, line))
        return;
...
void iLogMeta(const char* tag, iLogLevel level, const char* file, const char* function, int line, const T1& value1) {
    iLogger logger;
    if (!logger.start(tag, level, file, function, line))
        return;
