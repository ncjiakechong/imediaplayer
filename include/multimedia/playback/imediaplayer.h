...
protected:
    void _q_stateChanged(iMediaPlayer::State state);
    void _q_mediaStatusChanged(iMediaPlayer::MediaStatus status);
    void _q_error(int error, const iString &errorString);
    void _q_updateMedia(const iString&);
